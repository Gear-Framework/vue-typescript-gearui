let events = {
    ...
    onAfterRemove: GearType.Function,
    ...
    onBeforeChange: GearType.Function,
    ...
    onPageSizeChange: GearType.Function,
...
Object.defineProperty(events, "keys", {
    get: function() {
        ...
        for(let key in this) {
            if(key != "keys" && key != "cannotSetState" && key != "_events") {
...
// Object.defineProperty(events, "_events", {
//     get: function() {
//         let allevents = {};
//         for(let key in this) {
//             if(key != "keys" && key != "cannotSetState" && key != "_events") {
//                 allevents["_" + key] = this[key];
//             }
//         }
//         return allevents;
//     },
