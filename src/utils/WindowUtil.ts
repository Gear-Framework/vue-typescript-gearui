...
export default class WindowUtil {
    ...
    static addCssRule(selector: any, rules: any, index?: any) {
        let sheet = WindowUtil.createStyleSheet();
        index = index || 0;
        if (sheet.insertRule) { 
    ...
    */
    ...
    static domEventHandler(dom: Node) {
        //dom节点变化的监听
        (function(dom) {
            G.G$(dom).on("DOMNodeInserted", function(e: any) {
            ...
            G.G$(dom).on("DOMNodeRemoved", function(e: any) {
